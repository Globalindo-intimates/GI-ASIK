...
<head>
    ...
    <style>
        body  {
            background-image: url("<?php echo TEMPLATE_ASSETS;?>");
            height: 10%;
            ...
            <div class="col-md-6">
                <div class="card-group mb-0">
                    <div class="card cardLogin p-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                            <img src="<?php echo TEMPLATE_ASSETS;?>img/chart.png" 
                                width="170" 
                                height="90"
                            > 
                            </div>
                            ...
                            <span style="text-align: right;"> <p class="text-muted"><b><font color="Red">Aplikasi Sistem Informasi Karyawan</font></b></p> </span>
                            </div>
                        </div>    
