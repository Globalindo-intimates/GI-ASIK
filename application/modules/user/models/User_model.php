...
class User_model extends CI_Model
{
    ...
    {
        $sql = " SELECT * FROM productionreport.g_users INNER JOIN 
                productionreport.dt_role_user ON productionreport.g_users.GROUP_ID = productionreport.dt_role_user.group_id 
                ORDER BY productionreport.g_users.GROUP_ID Desc, productionreport.g_users.created_date Desc";
