...
$route['administrator/detail_personal/(:any)'] = 'detail_personil/$1';

$route['administrator/absensi_controller'] = 'personal_absensi/index';
$route['administrator/absensi_controller/(:any)'] = 'personal_absensi/$1';
